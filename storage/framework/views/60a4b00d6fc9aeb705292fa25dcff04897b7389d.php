                        ...
                        <form class="form-horizontal m-t-20" id="loginform" method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="form-group m-b-0 m-t-10">
                                <div class="col-sm-12 text-center">
                                    Don't have an account? <a href="<?php echo e(route('register')); ?>" class="text-info m-l-5"><b>Sign
                                            Up</b></a>
                                </div>
                            </div>
                        </form>
...
</html><?php /**PATH D:\laragon\www\v3\resources\views/welcome.blade.php ENDPATH**/ ?>