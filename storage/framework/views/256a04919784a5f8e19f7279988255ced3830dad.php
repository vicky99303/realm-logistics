                                ...
                                <?php if($dataCoupon->isNotEmpty()): ?>
                                    <?php $__currentLoopData = $dataCoupon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('user-journey',$single->id)); ?>">Journey List</a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('adminpanel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\realmlogostics\resources\views/adminpanel/user.blade.php ENDPATH**/ ?>