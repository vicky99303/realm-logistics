...
<div class="main-wrapper">
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center"
         style="background:url(<?php echo e(asset('adminpanel/')); ?>/assets/images/background/login-register.jpg) no-repeat center center;">
        <div class="auth-box on-sidebar">
            <div id="loginform">
                <div class="logo">
                    <span class="db"><img src="<?php echo e(asset('adminpanel/')); ?>/assets/images/logo-icon.png" alt="logo"/></span>
                ...
                <div class="row">
                    ...
                    <?php endif; ?>
                    <div class="col-12">
                        <form class="form-horizontal m-t-20" id="loginform" method="POST" action="<?php echo e(route('login-post')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg" name="email"
                                       placeholder="hello@example.com" value="<?php echo e(old('email')); ?>"
...
<?php /**PATH D:\laragon\www\realmlogostics\resources\views/welcome.blade.php ENDPATH**/ ?>