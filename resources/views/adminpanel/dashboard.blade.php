...
@section('content')
    @push('dashboardcss')
        ...
        <link rel="stylesheet" href="{{asset('adminpanel/vendor/chartist/css/chartist.min.css')}}">
    @endpush
    <!--**********************************
            Content body start
    ***********************************-->
                    ...
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ml-0">{{(isset($depositToday)?$depositToday:0)}}</span></h3>
