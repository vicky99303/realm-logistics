...
<head>
    ...
    <link href="{{asset('adminpanel/')}}/assets/extra-libs/c3/c3.min.css" rel="stylesheet">
    <link href="{{asset('adminpanel/')}}/assets/libs/morris.js/morris.css" rel="stylesheet">
    <!-- Custom CSS -->
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a href="{{route('sdashboard')}}" class="sidebar-link">
                            <i class="icon-Record"></i>
                            <span class="hide-menu">Dashboard</span></a></li>
                    <li class="sidebar-item"><a href="{{route('user')}}" class="sidebar-link">
                            <i class="icon-Record"></i>
...
<!--c3 charts -->
<script src="{{asset('adminpanel/')}}/assets/extra-libs/c3/d3.min.js"></script>
<script src="{{asset('adminpanel/')}}/assets/extra-libs/c3/c3.min.js"></script>
<!--chartjs -->
<script src="{{asset('adminpanel/')}}/assets/libs/raphael/raphael.min.js"></script>
<script src="{{asset('adminpanel/')}}/assets/libs/morris.js/morris.min.js"></script>
