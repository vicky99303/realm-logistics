...
@section('content')
        ...
        $(function () {
            ...
            function getTokenData() {
                return {
                    ...
                    deposit_id: $form.find('#deposit_id').val(),
            ...
            function ajaxCall(dataObject) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        deposit_id: getTokenDataVar.deposit_id,
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Buy Deposit Collection</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            @if($dataCoupon->isNotEmpty())
                                <table id="buyDepositDatatable" class="table table-striped table-bordered">
                                    <thead>
                                    <tr>
                                        <th>S. No</th>
                                        <th>deposit_id</th>
    ...
    ***********************************-->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Buy Deposit</h5>
                ...
                <div class="modal-body">
                    <form role="form" id="payment-form" method="POST" action="javascript:void(0);">
                        ...
                        <input class="form-control" type="hidden" id="api-key"
                               value="xnd_public_development_uzhyKyU7arC6hMCupZHycUtUqY4IDtx1admNLygJMIr8iDO1oyt7qZ54xtaxc"/>
                        <div class="form-row credit-card-box">
                            <div class="form-group col-md-6">
                                <label>Deposit</label>
                                <select id="deposit_id" name="deposit_id" class="form-control">
                                    <option selected>Choose...</option>
                                    @if($dataDeposit->isNotEmpty())
                                        @foreach($dataDeposit as $single)
                            ...
                            <div class="form-group col-md-6">
                                <label>Coupon</label>
                                <input class="form-control" type="text" id="coupon" min="1000" placeholder="Coupon" />
                            </div>
                            <div class="form-group col-md-6">
                                <label>AMOUNT</label>
                                <input class="form-control" type="text" id="amount" min="1000" placeholder="Amount" value="75000"
                                       required readonly/>
                            </div>
                            <div class="form-group col-md-6">
                                <label>CARD NUMBER</label>
                                <input class="form-control" type="text" id="card-number" placeholder="Card number"
                                       value="4000000000000002" required/> <br/>
                            </div>
                            <div class="form-group col-md-6">
                                <label>EXP </span>MONTH</label>
                                <input class="form-control" type="text" id="card-exp-month"
                                       placeholder="Card expiration month (mm)" value="12" required/>
                            </div>
                            <div class="form-group col-md-6">
                                <label>EXP </span>YEAR</label>
                                <input class="form-control" type="text" id="card-exp-year"
                                       placeholder="Card expiration year (yyyy)" value="2021" required/>
                            </div>
                            <div class="form-group col-md-6">
                                <label>CVN CODE</label>
                                <input class="form-control" type="text" id="card-cvn" placeholder="Cvn" value="123"
                                       required/>
                            </div>
                            <div class="form-group col-md-6">
    ...
    @push('packagejs')
        ...
        <script src="{{asset('adminpanel/js/custom/user/deposit.js')}}"></script>
    @endpush
@endsection
